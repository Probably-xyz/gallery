...
const Manifesto = () => {
  ...
  return (
    <div>
    <IoIosArrowRoundBack className="text-4xl text-prbly-dark cursor-pointer top-20 left-20 fixed" onClick={() => router.back()}/>
    <div className="py-24">
    <div className="max-w-screen-2xl flex flex-col">
        <div className="mx-auto">
            ...
            <h1 className="text-6xl text-center mt-2 font-medium" style={Main.style}> At the precipice of <br/> startup evolution </h1>
        </div>
        ...
        <div className=" w-2/5 mx-auto pt-12">
            ...
            <ul className="list-disc mt-3 ml-8">
                <li className="text-base font-light text-slate-600">No Ghosting</li>
                <li className="text-base font-light text-slate-600">No forcing founders to pay any fee</li>
                <li className="text-base font-light text-slate-600">No taking extra equity from founders</li>
            </ul>
        </div>
